namespace EnergyTrading.UnitTest.Registrars.Maps.Common.V2
{
    ...
    /// </summary>
    public class AnimalXmlMapper : EnergyTrading.UnitTest.Registrars.Maps.Common.V1.AnimalXmlMapper
    {
