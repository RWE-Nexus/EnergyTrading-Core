namespace EnergyTrading.Concurrency
{
        ...
        where T : IEquatable<T>
    {
        ...
        public VectorClock(IDictionary<T, int> value)
        {
            ...
            this.vector = value != null ? new Dictionary<T, int>(value)
        ...
        {           
            ...
            {
                int value;
                if (this.vector.TryGetValue(id, out value))
                {
                    this.vector[id] = value + 1;
                }
                else
                {
                    this.vector.Add(id, 1);
                }
            }
            finally
            {
        ...
        public VectorClock<T> Clone()
        {
            ...
            try
            {
                foreach (var entry in this.vector)
                {
        ...
        public override string ToString()
        {
            ...
            try
            {
                ...
                {
                    sb.AppendFormat("{0}[{1}]", key, this.vector[key]);
        ...
        {
            var keys = new List<T>(this.vector.Keys);
            keys.Sort();
