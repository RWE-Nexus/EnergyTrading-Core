namespace EnergyTrading.Mapping
{
    ...
    public class XmlConverter : IXmlConverter
    {
        ...
        public T FromXml<T>(string xml)
        {
            ...
            return this.FromXml<T>(processor, document.Root);
        }
        ...
        public T FromXml<T>(XElement element)
        {
            ...
            return this.FromXml<T>(processor, element);
        }
        ...
        public XElement ToXElement<T>(T entity, string version, bool localNamespaces = false)
        {
            try
            {
                ...
                var engine = this.Engine(version);
        ...
        public string ToXml<T>(T entity, string version, bool localNamespaces = false)
        {
            try
            {                
                var orderElement = this.ToXElement(entity, version, localNamespaces);
        ...
        private IXmlMappingEngine Engine(string version)
        {
            try
            {
                var engine = this.Factory.Find(version);
                if (engine != null)
                {
                    return engine;
                }
